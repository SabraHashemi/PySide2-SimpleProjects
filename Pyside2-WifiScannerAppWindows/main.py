    ...
    try:
        ...
        for iface in ifaces:
            ...
            try:
                ...
                self.ui.tableWidget.setHorizontalHeaderLabels(['Available wifi networks', '2'])
                self.ui.label_Mac.setText('here')
                for net2,net1 in zip(networks2,networks):
                   ...
                   # for i in range(0,126):
                    ...
                    #self.ui.tableWidget.
                    #self.ui.tableWidget.setColumnCount(2)
                    self.ui.tableWidget.setColumnHidden(1, 1);
                    rowPosition = self.ui.tableWidget.rowCount()
                    self.ui.tableWidget.insertRow(rowPosition)
                    self.ui.tableWidget.setItem(rowPosition , 0, QTableWidgetItem(SSID))
                    self.ui.tableWidget.setItem(rowPosition , 1, QTableWidgetItem(BSSID))
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_lunchLableme.clicked.connect(lambda: lunchLableMe(self))

        
        def cell_was_clicked(a,b):
            ccc=a;
            #print("Row %d and Column %d was clicked" % (a, b))
            item = self.ui.tableWidget.item(a, 1).text()
            self.ui.label_Mac.setText(item)
            #self.ID = item.text()
            #print(item )


        self.ui.tableWidget.cellClicked.connect(cell_was_clicked)
